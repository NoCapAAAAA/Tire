# Generated by Django 4.0.5 on 2023-04-07 11:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.periodofstorage', verbose_name='Срок хранения')),
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.tiresize', verbose_name='Размер шины')),
            ],
            options={
                'verbose_name': 'Цена',
                'verbose_name_plural': 'Цены',
                'ordering': ('size', 'period'),
            },
        ),
        migrations.CreateModel(
            name='OrderStorage',
            fields=[
                ...
                ('price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.price', verbose_name='Цена')),
